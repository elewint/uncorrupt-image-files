...
#     Modified by: Eli Intriligator (eintri01) and Katie Yang (zyang11)
#  	  Modification date: Sep 23, 2021
#
#  Maintenance targets:
#
#
...
#
# Add your own .h files to the right side of the assignment below.
INCLUDES = separator.h collision.h converter.h exceptions.h
...
#    executable.
#
# readaline: readaline.o
#	$(CC) $(LDFLAGS) -o readaline  readaline.o $(LDLIBS)
restoration: restoration.o readaline.o separator.o collision.o converter.o \
																exceptions.o
	$(CC) $(LDFLAGS) -o restoration $^ $(LDLIBS)
